class EventPrice < ApplicationRecord
  ...
  validates :base_price, :additional_hour_price, :additional_person_price, :weekend_base_price, :weekend_additional_hour_price, :weekend_additional_person_price, numericality: { greater_than: 0 }
end