  ...
  describe '#valid?' do
    ...
    context 'uniqueness' do
      it 'false when username is already in use' do
        ...
        user = User.new(username: 'usertest', full_name: 'Non-Unique User', social_security_number: "14355855007", contact_number: '(12) 92345-6789', email: 'nonunique@user.com', password: 'uniquepassword')
        expect(user.valid?).to eq false
      end

      it 'false when email is already in use' do
        User.create!(username: 'usertest', full_name: 'Test User', social_security_number: "01234567890", contact_number: '(11) 99876-5432', email: 'user@test.com', password: 'password')
        user = User.new(username: 'unique', full_name: 'Non-Unique User', social_security_number: "14355855007", contact_number: '(12) 92345-6789', email: 'user@test.com', password: 'uniquepassword')
        expect(user.valid?).to eq false
      end

      it 'false when social securiy number is already in use' do
        User.create!(username: 'usertest', full_name: 'Test User', social_security_number: "01234567890", contact_number: '(11) 99876-5432', email: 'user@test.com', password: 'password')
        user = User.new(username: 'unique', full_name: 'Non-Unique User', social_security_number: "01234567890", contact_number: '(12) 92345-6789', email: 'nonunique@test.com', password: 'uniquepassword')
        expect(user.valid?).to eq false
      end
    end
    ...
    context 'length' do
      it 'false when username is shorter than 5 characters' do
        user = User.new(username: 'user', full_name: 'Non-Unique User', contact_number: '(12) 92345-6789', social_security_number: "01234567890", email: 'nonunique@user.com', password: 'uniquepassword')
        expect(user.valid?).to eq false
      end

      it 'false when username is longer than 20 characters' do
        user = User.new(username: 'useruseruseruseruseruser', full_name: 'Non-Unique User', contact_number: '(12) 92345-6789', social_security_number: "01234567890", email: 'nonunique@user.com', password: 'uniquepassword')
        expect(user.valid?).to eq false
      end

      it 'false when password is shorter than 6 characters' do
        user = User.new(username: 'usertest', full_name: 'Non-Unique User', contact_number: '(12) 92345-6789', social_security_number: "01234567890", email: 'nonunique@user.com', password: 'passw')
        expect(user.valid?).to eq false
      end

      it 'false when contact number is shorter than 14 characters' do
        user = User.new(username: 'usertest', full_name: 'Non-Unique User', contact_number: '(12) 345-6789', social_security_number: "01234567890", email: 'nonunique@user.com', password: 'password')
        expect(user.valid?).to eq false
      end

      it 'false when contact number is longer than 15 characters' do
        user = User.new(username: 'usertest', full_name: 'Non-Unique User', contact_number: '(12) 92345-67891', social_security_number: "01234567890", email: 'nonunique@user.com', password: 'password')
        expect(user.valid?).to eq false
      end
    ...
    context 'enum' do
      it 'false when role is invalid' do
        ...
        social_security_number: "01234567890", email: 'nonunique@user.com', password: 'password', role: 'admin')}.to raise_error(ArgumentError)
      end
    end
  end
end
