...
RSpec.describe Order, type: :model do
  describe 'has multiple orders for desired date' do
    it 'returns true when multiple orders' do
      ...
      Order.create!(desired_date: '2024-05-16', estimated_invitees: 15, observation: 'Evento 1',
                    desired_address: 'Rua dos Bobos, 0', buffet: buffet, event: event, user: customer)
      order = Order.create!(desired_date: '2024-05-16', estimated_invitees: 20, observation: 'Evento 2',
                    desired_address: 'Rua dos Bobos, 0', buffet: buffet, event: event, user: customer)
    ...
    it 'returns false when no multiple orders' do
      ...
      Order.create!(desired_date: '2024-05-16', estimated_invitees: 15, observation: 'Evento 1',
                    desired_address: 'Rua dos Bobos, 0', buffet: buffet, event: event, user: customer)
      order = Order.create!(desired_date: '2024-07-08', estimated_invitees: 20, observation: 'Evento 2',
                    desired_address: 'Rua dos Bobos, 0', buffet: buffet, event: event, user: customer)
