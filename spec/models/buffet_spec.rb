  ...
  describe '#valid?' do
    ...
    context 'uniqueness' do
      it 'false when registration number is already in use' do
        ...
        buffet = Buffet.new(trading_name: 'Buffeteria', company_name: 'Buffet festas e cia', registration_number: Buffet.first.registration_number, contact_number: '(11) 91234-5678',
