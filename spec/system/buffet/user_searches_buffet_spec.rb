...
describe 'User searches a buffet' do
  ...
  it 'can search for a buffet name and find one result' do
    #Arrange
    User.create!(username: 'lucca', full_name: 'Gian Lucca', social_security_number: "01234567890", contact_number: '(12) 98686-8686',
  ...
  it 'can search for a buffet name and find multiple results' do
    #Arrange
    user1 = User.create!(username: 'lucca', full_name: 'Gian Lucca', social_security_number: "01234567890", contact_number: '(12) 98686-8686',
                email: 'gian@lucca.com', password: 'password', role: 'owner')
    buffet1 = Buffet.create!(trading_name: 'Buffet dos Anjos', company_name: 'Sem razão alguma', registration_number: '83.757.309/0001-58', contact_number: '(11) 99876-5432',
                  email: 'buffet@contato.com', address: 'Rua dos Bobos, 0', district: 'Bairro da Igrejinha', city: 'São Paulo', state: 'SP',
    ...
    user2 = User.create!(username: 'wladimir', full_name: 'Wladimir Souza', social_security_number: "14355855007", contact_number: '(12) 97676-7676', email: 'wladimir@souza.com', password: 'password', role: 'owner')
    buffet2 = Buffet.create!(trading_name: 'Buffet dos Anjos', company_name: 'Razões muito especificas', registration_number: '43.521.735/0001-79', contact_number: '(12) 91234-5678',
    ...
    user3 = User.create!(username: 'lucas', full_name: 'Lucas Felipe', social_security_number: "74488238092", contact_number: '(12) 94545-4545', email: 'lucas@felipe.com', password: 'password', role: 'owner')
